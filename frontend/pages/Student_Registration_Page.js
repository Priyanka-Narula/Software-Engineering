export default {
    template: `
      <div class="registration-page" style="max-width: 500px; margin: 0 auto; text-align: center; padding: 20px; border: 1px solid #ddd; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); background-color: #ffffff;">
        <h1 style="font-size: 36px; font-weight: bold; margin-bottom: 20px;">Register for EduNex</h1>
        <p style="font-size: 18px; margin-bottom: 30px;">Create your student account.</p>
